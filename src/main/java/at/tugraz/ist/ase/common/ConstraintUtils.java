...
////     */
////    public void printListListConstraints(List<List<String>> allDiag, String mess) {
////        int count = 0;
...
////    }
////
////    public void printListSetConstraints(List<Set<String>> allDiag, String mess) {
////        int count = 0;
...
////    }
//
////    public void printConstraints(Set<String> ac) {
////        String.join("\n", ac);
////        ac.forEach(System.out::println);
////    }
//
////    public void loadConstraints(InputStream inputFile, Model model) {
