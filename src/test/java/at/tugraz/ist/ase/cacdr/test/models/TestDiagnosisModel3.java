...
import static at.tugraz.ist.ase.cacdr.test.core.ModelsForTest.createModel3;

public class TestDiagnosisModel3 extends CDRModel implements IChocoModel {
    @Getter
    private Model model;

    public TestDiagnosisModel3(String name) {
        super(name);
    }
