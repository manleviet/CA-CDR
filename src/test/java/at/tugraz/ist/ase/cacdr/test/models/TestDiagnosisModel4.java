...
import static at.tugraz.ist.ase.cacdr.test.core.ModelsForTest.createModel4;

public class TestDiagnosisModel4 extends CDRModel implements IChocoModel {
    @Getter
    private Model model;

    public TestDiagnosisModel4(String name) {
        super(name);
    }
